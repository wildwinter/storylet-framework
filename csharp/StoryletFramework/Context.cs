...
namespace StoryletFramework
{
    public static class ContextUtils
    {
        ...
        public static object EvalExpression(object val, Dictionary<string, object> context, List<string>? dumpEval = null)
        {
        ...
        // dumpEval will fill a list with evaluation debug steps
        public static void InitContext(Dictionary<string, object> context, Dictionary<string, object> properties, List<string>? dumpEval = null)
        {
        ...
        // dumpEval will fill a list with evaluation debug steps
        public static void UpdateContext(Dictionary<string, object> context, Dictionary<string, object> updates, List<string>? dumpEval = null)
        {
        ...
        public static string DumpContext(Dictionary<string, object> context)
        {
